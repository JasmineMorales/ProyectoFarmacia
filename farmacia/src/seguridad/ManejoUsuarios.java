...
public class ManejoUsuarios {
    ...
    public ArrayList<Usuario> getUsuarios(){
        ...
        try {
            ...
            String consulta = "SELECT us.idUsuario, us.Nombre, acc.Codigo, acc.Nombre, us.direccion, us.salario, us.prestaciones FROM usuario us INNER JOIN accesos acc ON us.Accesos_id = acc.id";//se consulta la info de acceso
            ...
            while(resultado.next()){
                usuarios.add(new Usuario(resultado.getInt(3), resultado.getInt(1), resultado.getString(2), resultado.getString(4), resultado.getString(5), resultado.getFloat(6), resultado.getFloat(7)));
            }
            conexionDB.close();
            return usuarios;
    ...
    public boolean crearUsuario(String userName, String calve, int acceso, String direccion, float salario, float prestaciones){
        try {
            conexionDB = Conexion.conectar();//se conecta a la base de datos
            ...
            if (creacion==1) {
                ...
                String consulta2 = "UPDATE usuario set direccion = \""+direccion+"\", salario = " + salario+ ", prestaciones = "+prestaciones+" where nombre =\"" + userName +"\"" ;
                pre = conexionDB.prepareStatement(consulta2);
